...
const settingsItems = [
  { to: '/admin/announcement', name: 'admin-announcement', label: '公告', icon: 'edit' },
  { to: '/admin/tutorials', name: 'admin-tutorials', label: '教程', icon: 'copy' },
  ...
  { to: '/admin/email', name: 'admin-email', label: '邮箱', icon: 'mail' },
  { to: '/admin/site-settings', name: 'admin-site-settings', label: '网站信息', icon: 'edit' },
  { to: '/admin/subscription-settings', name: 'admin-subscription-settings', label: '订阅', icon: 'refresh' },
]
...
.al-brand-logo:has(img) { background: transparent; }
.al-brand-logo-img {
  width: 32px;
  height: 32px;
  object-fit: contain;
